...
\path[draw=black,fill=red!50]   ( 3, 0.1) --++ (1,0) --++ (0,1) -++ (-1,0) --cycle;
\path[draw=black,fill=red!50]   ( 0, 0.1) --++ (-1,0) --++ (0,1) -++ (+1,0) --cycle;


\draw [<->,brown]   (-1,1.3) -- (0,1.3) node [black,sloped,midway,above] {$\sfrac{b^{(k+1)}}{2}$};

\draw [<->,brown]   (3,1.3) -- (4,1.3) node [black,sloped,midway,above] {$\sfrac{b^{(k+1)}}{2}$};
