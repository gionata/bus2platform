...
\end{scope}
  ...
  \node (4) at (154bp,316bp) [draw,circle,fill=red,opacity=0.5] {$1$};
  \node (5) at (154bp,230bp) [draw,circle,fill=blue,opacity=0.5] {$2$};
  \node (6) at (154bp,144bp) [draw,circle,fill=green,opacity=0.5] {$3$};
  \path[] (1) edge (4);
  \path[] (1) edge (5);
  \path[] (2) edge (4);
  \path[] (2) edge (6);
