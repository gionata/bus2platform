...
public:
	...
	void performances_airo2011(int *solution, unsigned int &used_platform, unsigned int &min_interval_distance, double &cprob_lin, double &cprob_exp, double &mean_distance) const;
